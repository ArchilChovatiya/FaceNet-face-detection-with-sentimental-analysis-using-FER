...
interpreter = tf.contrib.lite.Interpreter(model_path="tf_lite_model.tflite")
                        ...
                        if best_class_probabilities>0.53:
                            ...
                            for H_i in HumanNames:
                                if HumanNames[best_class_indices[0]] == H_i:
                                    ...
                                    cv2.putText(frame, emotion_dict[int(np.argmax(prediction))], (text_x+15, text_y+15), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 1, cv2.LINE_AA)
                                    cv2.putText(frame, 'is', (text_x, text_y+15), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 1, cv2.LINE_AA)
                else:
